...
import { Upload, Building, CreditCard, Shield, Trash2, LogOut } from "lucide-react"
...
export default function Settings() {
  const [profileData, setProfileData] = useState({
    ...
    description:
      "A cozy restaurant serving delicious food since 2010. We specialize in fresh, locally-sourced ingredients.",
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeIn}>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your restaurant's appearance and information</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-500">
                  This section allows you to customize how your restaurant appears to customers when they scan your QR
                  code. You can update your restaurant's information, upload images, and set your operating hours.
                </p>
                <div className="mt-6 space-y-6">
                  <div>
                    <h3 className="text-lg font-medium mb-4">Restaurant Appearance</h3>
                      ...
                      {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map((day) => (
                        <div key={day} className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span>to</span>
                            <Input type="time" className="w-32" defaultValue="21:00" />
                          </div>
                        </div>
                      ))}
                    </div>
              ...
              <CardContent className="space-y-6">
                <div className="bg-primary/10 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-bold text-primary">Professional Plan</h3>
                    <Badge>Active</Badge>
                  </div>
                  <p className="text-sm mb-4">Your subscription renews on August 15, 2023</p>
                  ...
                  <div className="border rounded-lg overflow-hidden">
                    <table className="min-w-full divide-y">
                      ...
                      <tbody className="bg-white divide-y">
                        {[
                          { date: "Jul 15, 2023", amount: "$59.00", status: "Paid" },
                          { date: "Jun 15, 2023", amount: "$59.00", status: "Paid" },
                          { date: "May 15, 2023", amount: "$59.00", status: "Paid" },
                        ].map((invoice, index) => (
                          <tr key={index}>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Get notified when customers view your menu</p>
                        </div>
                        <Switch
                          checked={notificationSettings.menuViews}
                          onCheckedChange={(checked) => handleNotificationChange("menuViews", checked)}
                        />
                      </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-500">Chrome on Windows • New York, USA • Started 2 hours ago</p>
                    </div>
                    <Button variant="outline" className="text-red-600">
                      <LogOut className="mr-2 h-4 w-4" /> Sign Out of All Sessions
                    </Button>
                  </div>
                </div>
              </CardContent>
