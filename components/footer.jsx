...
import { QrCode, Facebook, Twitter, Instagram, Mail, Phone } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold accent-font">DigiDine</span>
            </div>
            <p className="text-sm text-gray-300 max-w-xs">
              Transform your restaurant experience with digital menus and QR code technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/demo" className="text-gray-300 hover:text-accent transition-colors">
                  Demo
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/guides" className="text-gray-300 hover:text-accent transition-colors">
                  Guides
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-12 pt-6 text-sm text-gray-400">
          <div className="flex flex-col md:flex-row justify-between gap-4">
            <p>© {new Date().getFullYear()} DigiDine. All rights reserved.</p>
